...
* V. Spring Boot执行器: Production-ready特性
   ...
   * [40. 端点](V. Spring Boot Actuator: Production-ready features/40. Endpoints.md)
      ...
      * [40.3. 安全与HealthIndicators](V. Spring Boot Actuator: Production-ready features/40.3. Security with HealthIndicators.md)
         * [40.3.1. 自动配置的HealthIndicators](V. Spring Boot Actuator: Production-ready features/40.3.1. Auto-configured-HealthIndicators.md)
         * [40.3.2. 编写自定义HealthIndicators](V. Spring Boot Actuator: Production-ready features/40.3.2. Writing custom HealthIndicators.md)
      * [40.4. 自定义应用info信息](V. Spring Boot Actuator: Production-ready features/40.4. Custom application info information.md)
         * [40.4.1. 在构建时期自动扩展info属性](V. Spring Boot Actuator: Production-ready features/40.4.1. Automatically expand info properties at build time.md)
         * [40.4.2. Git提交信息](V. Spring Boot Actuator: Production-ready features/40.4.2. Git commit information.md)
   * [41. 基于HTTP的监控和管理](V. Spring Boot Actuator: Production-ready features/41. Monitoring and management over HTTP.md)
      * [41.1. 保护敏感端点](V. Spring Boot Actuator: Production-ready features/41.1. Securing sensitive endpoints.md)
      * [41.2. 自定义管理服务器的上下文路径](V. Spring Boot Actuator: Production-ready features/41.2. Customizing the management server context path.md)
      * [41.3. 自定义管理服务器的端口](V. Spring Boot Actuator: Production-ready features/41.3. Customizing the management server port.md)
      * [41.4. 自定义管理服务器的地址](V. Spring Boot Actuator: Production-ready features/41.4. Customizing the management server address.md)
      * [41.5. 禁用HTTP端点](V. Spring Boot Actuator: Production-ready features/41.5. Disabling HTTP endpoints.md)
      * [41.6. HTTP Health端点访问限制](V. Spring Boot Actuator: Production-ready features/41.6. HTTP Health endpoint access restrictions.md)
   * [42. 基于JMX的监控和管理](V. Spring Boot Actuator: Production-ready features/42. Monitoring and management over JMX.md)
      * [42.1. 自定义MBean名称](V. Spring Boot Actuator: Production-ready features/42.1. Customizing MBean names.md)
      * [42.2. 禁用JMX端点](V. Spring Boot Actuator: Production-ready features/42.2. Disabling JMX endpoints.md)
      * [42.3. 使用Jolokia通过HTTP实现JMX远程管理](V. Spring Boot Actuator: Production-ready features/42.3. Using Jolokia for JMX over HTTP.md)
         * [42.3.1. 自定义Jolokia](V. Spring Boot Actuator: Production-ready features/42.3.1. Customizing Jolokia.md)
         * [42.3.2. 禁用Jolokia](V. Spring Boot Actuator: Production-ready features/42.3.2. Disabling Jolokia.md)
      * [43. 使用远程shell来进行监控和管理](V. Spring Boot Actuator: Production-ready features/43. Monitoring and management using a remote shell.md)
         * [43.1. 连接远程shell](V. Spring Boot Actuator: Production-ready features/43.1. Connecting to the remote shell.md)
            * [43.1.1. 远程shell证书](V. Spring Boot Actuator: Production-ready features/43.1.1. Remote shell credentials.md)
         * [43.2. 扩展远程shell](V. Spring Boot Actuator: Production-ready features/43.2. Extending the remote shell.md)
            * [43.2.1. 远程shell命令](V. Spring Boot Actuator: Production-ready features/43.2.1. Remote shell commands.md)
            * [43.2.2. 远程shell插件](V. Spring Boot Actuator: Production-ready features/43.2.2. Remote shell plugins.md)
      * [44. 度量指标（Metrics）](V. Spring Boot Actuator: Production-ready features/44. Metrics.md)
         * [44.1. 系统指标](V. Spring Boot Actuator: Production-ready features/44.1. System metrics.md)
         * [44.2. 数据源指标](V. Spring Boot Actuator: Production-ready features/44.2. DataSource metrics.md)
         * [44.3. Tomcat session指标](V. Spring Boot Actuator: Production-ready features/44.3. Tomcat session metrics.md)
         * [44.4. 记录自己的指标](V. Spring Boot Actuator: Production-ready features/44.4. Recording your own metrics.md)
         * [44.5. 添加你自己的公共指标](V. Spring Boot Actuator: Production-ready features/44.5. Adding your own public metrics.md)
         * [44.6. 指标仓库](V. Spring Boot Actuator: Production-ready features/44.6. Metric repositories.md)
         * [44.7. Dropwizard指标](V. Spring Boot Actuator: Production-ready features/44.7. Dropwizard Metrics.md)
         * [44.8. 消息渠道集成](V. Spring Boot Actuator: Production-ready features/44.8. Message channel integration.md)
      * [45. 审计](V. Spring Boot Actuator: Production-ready features/45. Auditing.md)
      * [46. 追踪（Tracing）](V. Spring Boot Actuator: Production-ready features/46. Tracing.md)
         * [46.1. 自定义追踪](V. Spring Boot Actuator: Production-ready features/46.1. Custom tracing.md)
