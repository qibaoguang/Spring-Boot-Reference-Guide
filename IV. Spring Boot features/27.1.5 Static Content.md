...
Spring Boot也支持Spring MVC提供的高级资源处理特性，可用于缓存琐碎的静态资源或对WebJar使用版本无感知的URLs。
...
以下的配置为所有的静态资源提供一种缓存方案，实际上是将内容hash添加到URLs中，比如`<link href="/css/spring-2a2d595e6ed9a0b24f027f2b63b134d6.css"/>`：
```properties
